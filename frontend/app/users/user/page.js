  ...
  const getFood = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setFood(foodData);
        setFilteredFood(foodData); // Initialize filtered list with all food
      } else {
    ...
    <div className="flex flex-col bg-gray-100 min-h-screen">
      <div className="bg-white flex items-center justify-between px-4 py-2">
        ...
        <div className="relative cursor-pointer  " onClick={handleCartClick}>
          ...
          <div className="bg-gray-300 p-[1px] w-[35px] rounded-3xl">
          <Image
            src={userIcon}
            alt="Profile"
      ...
      {showProfile && (
        <div className="absolute top-12 right-4 bg-white p-4 shadow-md rounded-lg">
